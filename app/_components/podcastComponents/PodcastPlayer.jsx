"use client";
import LoaderLarge from "@/app/_components/mainComponents/LoaderLarge";
      ...
      {isLoading ? (
        ...
        <div>
          <div className="relative h-96 w-full overflow-hidden">
            ...
            />
            {/* Overlay for title */}
            <div className="absolute w-full inset-0 bg-gradient-to-t from-black/70 to-transparent dark:from-white/70 flex items-end">
              <div className="flex items-center w-full">
                <div className="flex px-2 flex-col gap-2 py-2">
                  ...
                  <h1 className="text-xl font-medium text-white dark:text-black">
                    {podcast.podcastName}
                  </h1>
                </div>
                <div className="ml-auto mr-2">
                  <Podcast className="size-20 animate-pulse text-stone-50" />
                </div>
              </div>
            </div>
          </div>
